            ...
            <div className="navbar bg-transparent p-5 font-bold max-w-7xl mx-auto">
                <div className="navbar-start">
                    ...
                    <div className="flex items-center">
                        <img className="w-12" src="https://cdn.pixabay.com/photo/2013/07/13/11/44/penguin-158551_1280.png" alt="" />
                        <h2 className="font-bold text-4xl ml-3 hidden lg:block">Toy Shop</h2>
                    </div>
                </div>
