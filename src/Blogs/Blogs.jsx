        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="mb-6">
                <div className="rounded-lg p-6 shadow-md bg-gray-100">
                    ...
                    <span className="font-semibold">Refresh Token:</span> A refresh token is a long-lived credential that is used to obtain a new access token when the current one expires. Unlike access tokens, refresh tokens are not meant to be included with each request to access protected resources. Instead, they are securely stored on the client-side, typically within a secure session or a token vault. When the access token expires, the client can use the refresh token to request a new access token from the authentication server without requiring the user to re-authenticate.</p>
                </div>
            </div>
